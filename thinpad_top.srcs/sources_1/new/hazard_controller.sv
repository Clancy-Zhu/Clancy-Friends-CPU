...
module hazard_controller (
  ...
  always_comb begin
    ...
    if (wb_flush_i) begin
      ...
      ex_dmmu_flush_o = 1;
      dmmu_mem_flush_o = 1;
    end else if (dmmu_flush_i) begin
      _if_flush_o = 1;
      immu_if_flush_o = 1;
      if_id_flush_o = 1;
      id_ex_flush_o = 1;
      ...
      _if_flush_o = 1;
      immu_if_flush_o = 1;
    end else if (immu_flush_i) begin
      _if_flush_o =1;
      ...
      dmmu_mem_stall_o = 1;
      mem_wb_flush_o = 1;
    end else if (dmmu_stall_i) begin
      _if_stall_o = 1;
      immu_if_stall_o = 1;
      if_id_stall_o = 1;
      id_ex_stall_o = 1;
      ...
      if_id_flush_o = 1;
      // immu_if_flush_o = 1;
    end else if (immu_stall_i) begin
      _if_stall_o = 1;
      immu_if_flush_o = 1;
    end
  end
