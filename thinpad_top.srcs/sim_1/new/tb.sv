...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:\\cod\\cod23-grp31\\temp\\ucore\\rbl.img"; // BaseRAM 初始化文件，请修改为实际的绝对路�???
  parameter EXT_RAM_INIT_FILE = "D:\\cod\\cod23-grp31\\temp\\ucore\\ucore_rm.img";  // ExtRAM 初始化文件，请修改为实际的绝对路�???
  ...
  begin
    ...
    for (integer i = 0; i < n_Init_Size; i++)
    begin
